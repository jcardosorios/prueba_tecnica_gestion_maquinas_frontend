    ...
    return (
        ...
        >
            <div className="flex flex-col">
                ...
                >
                    <option value="" disabled hidden selected>Seleccione una máquina</option>
                    {data?.map((maquina) => {
            ...
            <div className="flex flex-col">
                ...
                <div className='flex gap-2'>
                    <Popover.Root open={openCalendarStart} onOpenChange={setOpenCalendarStart}>
                        <Popover.Trigger asChild>
                            <div id='fecha_hora_inicio' type="button" className={twMerge("flex-1 justify-start text-left font-normal h-10 px-4 py-2 bg-background hover:bg-accent hover:text-accent-foreground inline-flex items-center whitespace-nowrap rounded-md border border-input text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2", !getValues("fecha_hora_inicio") && "text-muted-foreground")}>
            ...
            <div className="flex flex-col">
                ...
                <input type="hidden" {...register("fecha_hora_termino", {
                    validate: (value) => {
                        ...
                        console.log(value && fechaInicio && value < fechaInicio)
